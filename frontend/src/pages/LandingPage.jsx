    ...
    <>
      ...
      {(!showModal && !successData) && (
        <a 
          ...
          target="_blank" 
          rel="noreferrer"
          style={{ position: 'fixed', bottom: '24px', right: '24px', zIndex: 9999, backgroundColor: '#25D366', color: 'white', padding: '12px 20px', borderRadius: '9999px', display: 'flex', alignItems: 'center', gap: '10px', boxShadow: '0 10px 25px -5px rgba(37, 211, 102, 0.4)', textDecoration: 'none', fontWeight: '600' }}
        >
